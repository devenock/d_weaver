...
type JWTConfig struct {
	...
	PrivateKeyPath         string // RS256 private key path
	PublicKeyPath          string // RS256 public key path
	Issuer                 string
	RefreshTokenSecret     string // or path to secret for symmetric fallback if needed
}
